 ...
 */
public class T01_PushMessage {
    public static void main(String[] args) throws Exception{
//        String serverUrl = "http://localhost:8180/trApp/label/comment/pushMessage";
                String serverUrl = "http://112.74.92.17:8080/trApp/label/comment/pushMessage";
...
//        queryParams.put("token", "1f0ad46b16994df895aabc531de8fc65");
        ...
        appParams.put("msg", "push message test");
