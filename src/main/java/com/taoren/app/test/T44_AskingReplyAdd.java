 ...
 */
public class T44_AskingReplyAdd {
    public static void main(String[] args) throws Exception{
//        String serverUrl = "http://localhost:8180/trApp/asking/reply/add";
                String serverUrl = "http://112.74.92.17:8080/trApp/asking/reply/add";
...
//        queryParams.put("token", "1f0ad46b16994df895aabc531de8fc65");
        ...
        appParams.put("askingId", "300000051");
        appParams.put("uid", "100000003");

        appParams.put("replyDetail", "回复喊话");
