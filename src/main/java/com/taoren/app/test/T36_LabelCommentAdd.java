 ...
 */
public class T36_LabelCommentAdd {
    public static void main(String[] args) throws Exception{
//        String serverUrl = "http://localhost:8180/trApp/label/comment/add";
...
//        queryParams.put("token", "1f0ad46b16994df895aabc531de8fc65");
        ...
        appParams.put("uid", "100000017");//100000017
        appParams.put("labelId", "300000360");//300000360
