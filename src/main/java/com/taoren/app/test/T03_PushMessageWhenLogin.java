 ...
 */
public class T03_PushMessageWhenLogin {
    public static void main(String[] args) throws Exception{
        String serverUrl = "http://localhost:8180/trApp/label/comment/pushMessageWhenLogin";
//                String serverUrl = "http://112.74.92.17:8080/trApp/label/comment/add";
...
//        queryParams.put("token", "1f0ad46b16994df895aabc531de8fc65");
        ...
        appParams.put("deviceToken", "3d059261 1cde6d8d 1d8d8fa9 e1faefb4 c81d663f 7d3acbc2 c8b0f864 bc8e4123");
        appParams.put("uid", "100000525");

//        appParams.put("commentDetail", "我还想评论");
//        appParams.put("replyTo", "100000001");
