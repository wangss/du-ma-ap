 ...
 */
public class T02_SaveMessageWhenLogout {
    public static void main(String[] args) throws Exception{
        String serverUrl = "http://localhost:8180/trApp/label/comment/saveMessageWhenLogout";
...
//        queryParams.put("token", "1f0ad46b16994df895aabc531de8fc65");
        ...
        appParams.put("msg", "push message test 啦啦啦");
