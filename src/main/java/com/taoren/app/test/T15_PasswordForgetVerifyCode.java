 ...
 */
public class T15_PasswordForgetVerifyCode {
    public static void main(String[] args) throws Exception{
//        String serverUrl = "http://localhost:8080/trApp/login/password/verifyCode";
        String serverUrl = "http://112.74.92.17:8080/trApp/login/password/verifyCode";
        ...
        appParams.put("phone", "13539652812");
