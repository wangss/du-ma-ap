 ...
 */
public class T46_AskingReplyList {
    public static void main(String[] args) throws Exception{
        String serverUrl = "http://localhost:8180/trApp/asking/reply/list";
...
//        queryParams.put("token", "1f0ad46b16994df895aabc531de8fc65");
        ...
        appParams.put("askingId", "300000004");

//        appParams.put("replyDetail", "我又回复你的喊话了， 啦啦啦");
